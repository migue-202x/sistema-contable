...
//        $mail->addAddress('miguel.elias.gatica2019@gmail.com', 'Receptor Joe User');  
    ...
    //    $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
        ...
        $mail->Body    = 'Estimado '.$name.', en respuesta a la solicitud de clave para Crear Empresa, ingrese esta clave única: '.$contrasenia.' . Proteja esta contraseña, con la misma podrá realizar copias de seguridad y restauración. Si desea crear otra empresa, volver a solicitar una nueva clave. Proteja su contraseña de SOPORTE= "333"';
