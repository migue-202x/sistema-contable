...
<html>
    <head>
        ...
        <script src="asiento/js/asientofunciones.js"></script>

    </head>
    <header>
        <div id="header">
                    <ul class="nav navbar-nav">
                        <li><a class="btn btn-primary btn-lg" href="contabilidad.php">CONTABILIDAD</a></li>
                    </ul>
   
                    <ul class="nav navbar-nav">
                        <li><a class="btn btn-primary btn-lg" href="facturacion.php">FACTURACION</a></li> 
                    </ul>
        </div>  
    </header>
