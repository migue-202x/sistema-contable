...
<div class="logoContornoWhite">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">  
                                ...
                                <label class="labelWhite">Listar Libro Diario: </label>
                                <br><br>
                                  <div class="input-group">   
                                    <!-- <span class="input-group-addon">Desde: </span>  
                                    <input id="fecha1" type="text" class="input-sm form-control" name="start" /> -->
      ...
      <div class="col-sm-3">
        <button id="btnfechasLibDiario" type="text" class="btn btn-success btn-lg">Filtrar</button>
      </div>
...
<script type="text/javascript">
 ...
 $(document).ready(function () {
  ...
  $('#btnfechasLibDiario').click(function () {
  // $('#modal-date').modal();
      // fecha1 = $('#fecha1').val(); 
      fecha2 = $('#fecha2').val(); 
      ...
      $.ajax({
        type: "GET",
        url: "setFechasLibDiario.php",
        data: cadena,
        })
        .done(function(resultado){
          // res = JSON.parse(resultado);
          // console.log(res);
          window.location.href = "salidaLibroDiario.php";
