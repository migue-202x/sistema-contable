...
<div class="logoContornoWhite">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">  
                                ...
                                <label class="labelWhite">Ingresar para listar Balance: </label>
                                <br><br>
                                  <div class="input-group">   
      ...
      <div class="col-sm-3">
        <button id="btnfechasBalances" type="text" class="btn btn-success btn-lg">Filtrar</button>
      </div>
...
<script type="text/javascript">
 ...
 $(document).ready(function () {
  ...
  $('#btnfechasBalances').click(function () {
  // $('#modal-date').modal();
      fecha1 = $('#fecha1').val(); 
      fecha2 = $('#fecha2').val(); 
      ...
      $.ajax({
        type: "POST",
        url: "setFechasBal.php",
        data: cadena,
        })
        .done(function(resultado){
          // res = JSON.parse(resultado);
          // console.log(res);
          window.location.href = "salidaBalances.php";
