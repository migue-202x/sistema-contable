...
//
        ...
        $sql1 = ("SELECT asientoborrador.fecha_contable AS fecha FROM asientoborrador WHERE asientoborrador.num_asiento = $num_asiento LIMIT 1"); 
        $stament = $conn->prepare($sql1);
        $stament->execute();
...
//                                        
             ...
             return 'ok'; 
//            return json_encode($fechaContable);
}
